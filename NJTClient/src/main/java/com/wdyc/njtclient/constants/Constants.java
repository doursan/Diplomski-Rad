 ...
 */
package com.wdyc.njtclient.constants;
...
public class Constants {
    ...
    public static final String USER_SHOP_NAME_PARAM = "name";
    public static final String CARS_USER_PARAM = "user";
    public static final String CARS_VIN_PARAM = "vin";
    public static final String CARS_REGISTRATION_PARAM = "registration";
    public static final String CARS_REGISTRATION_SUGGEST_PARAM = "registration_suggest";
    public static final String BUYER_SUGGEST_PARAM = "buyer_suggest";
    public static final String SERVICE_ID_PARAM = "id";
    public static final String PART_ID_PARAM = "id";
    public static final String PART_NAME_PARAM = "name";
    ...
    public static final String SERVICES_NAME_PARAM = "name";
    ...
    public static final String REPAIRS_ID_PARAM = "repair_id";
}
