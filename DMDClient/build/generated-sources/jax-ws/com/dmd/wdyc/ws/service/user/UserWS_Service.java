 ...
 * 
 */
@WebServiceClient(name = "UserWS", targetNamespace = "http://user.service.ws.wdyc.dmd.com/", wsdlLocation = "http://localhost:8080/DMDWS/UserWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWS_QNAME = new QName("http://user.service.ws.wdyc.dmd.com/", "UserWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/DMDWS/UserWS?wsdl");
    ...
    public UserWS getUserWSPort() {
        return super.getPort(new QName("http://user.service.ws.wdyc.dmd.com/", "UserWSPort"), UserWS.class);
    }
    ...
    public UserWS getUserWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://user.service.ws.wdyc.dmd.com/", "UserWSPort"), UserWS.class, features);
    }
