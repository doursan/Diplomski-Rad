...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/DMDClient/pages/css/login1.css" type="text/css">
    </head>
    <body>
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="panel panel-login">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form id="login-form" action="/DMDClient/controller" method="post" role="form" style="display: block;">
                                    ...
                                    <form id="register-form-shop" action="/DMDClient/controller" method="post" role="form" style="display: none;">
                                    ...
                                    <form id="register-form-customer" action="/DMDClient/controller" method="post" role="form" style="display: none;">
                                        <input type="hidden" name="action" value="register" />
                                        <div class="form-group">
                                            <input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Username" value="">
                                        </div>
